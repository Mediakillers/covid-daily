...
with open('/home/a4iv1kv14b88/covid_map/outputs/venues_{}.csv'.format(datetime.now().strftime("%Y-%m-%dT%H:%M:%S")),
          'w') as csvfile:
    writer = csv.DictWriter(csvfile, fieldnames=fields)
    writer.writeheader()
    writer.writerows(response.json())
copyfile("/home/a4iv1kv14b88/covid_map/outputs/venues_{}.csv".format(datetime.now().strftime("%Y-%m-%dT%H:%M:%S")),
